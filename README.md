...
| [fastapi/relational-widgets](fastapi/relational-widgets/) | Python / FastAPI + PostgreSQL | Go / Fiber, chi, mux, Gin (published `api-converters-v0.1.0a8`) | All five CLI stages; three Alembic revisions including default backfill, 17 HTTP/database comparisons, existing-row transfer, post-transfer parity and rollback |
