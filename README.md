...
| [fastapi/relational-widgets](fastapi/relational-widgets/) | Python / FastAPI + PostgreSQL | Go / Fiber, chi, mux, Gin (published `api-converters-v0.1.0a7`) | All five CLI stages; two Alembic revisions, 17 HTTP/database comparisons, existing-row transfer, post-transfer parity and rollback |
